<div class="box-header with-border">
    <h3 class="box-title"> {{ trans('cms.new') }}  {!! trans('social_stream::social_wall.name') !!} </h3>
...
<div class="box-body" >
    <div class="nav-tabs-custom">
        ...
        <ul class="nav nav-tabs primary">
            <li class="active"><a href="#details" data-toggle="tab">SocialWall</a></li>
        </ul>
...
(function ($) {
    $('#btn-save').click(function(){
        $('#create-social_stream-social_wall').submit();
    });
    $('#btn-cancel').click(function(){
        $('#entry-social_wall').load('{!!URL::to('admin/social_stream/social_wall/0')!!}');
    });
    $('#create-social_stream-social_wall')
    .submit( function( e ) {
        if($('#create-social_stream-social_wall').valid() == false) {
